define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'box/detail/index' + location.search,
                    add_url: 'box/detail/add' + Config.boxid_filter,
                    edit_url: 'box/detail/edit',
                    del_url: 'box/detail/del',
                    multi_url: 'box/detail/multi',
                    import_url: 'box/detail/import',
                    table: 'box_detail',
                }
            });
